...
bananaImg=loadImage("images/bananas.png")
fresaImg=loadImage("images/fresa.png")
naranjaImg=loadImage("images/naranja.png")
ceresaImg=loadImage("images/ceresas.png")
fantasma_rosaImg=loadAnimation("images/FantasmaRosa/FR1.png","images/FantasmaRosa/FR2.png","images/FantasmaRosa/FR3.png")
fantasma_AzulImg=loadAnimation("images/FantasmaAzul/FA1.gif","images/FantasmaAzul/FA2.gif","images/FantasmaAzul/FA3.gif")
fantasma_RojoImg=loadImage("images/Fantasma_rojo.png")
fantasma_naranjaImg=loadImage("images/Fantasma_naranja.png")
Pac_ManImg=loadAnimation("images/Pac-man/Pac1.gif","images/Pac-man/Pac2.gif")
}
...
Pac_Man.addAnimation("Pac-man",Pac_ManImg)
Pac_Man.scale=0.2
console.log(Pac_Man.x)
//sprites frutas
naranjas = createSprite(279,135,20,20)
naranjas.addImage("naranja",naranjaImg);
naranjas.scale=0.15
bananas = createSprite(310,135,20,20)
bananas.addImage("bananas",bananaImg);
bananas.scale=0.1
fresas = createSprite(335,135,20,20)
fresas.addImage("fresa",fresaImg);
fresas.scale=0.15
cereza = createSprite(360,130,20,20)
cereza.addImage("cereza",ceresaImg);
cereza.scale=0.15
...
fantasma_rosa.addAnimation("Fantasma_rosa",fantasma_rosaImg)
fantasma_rosa.scale=0.10
fantasma_naranja = createSprite(285,204,15,15)
fantasma_naranja.shapeColor="red"
fantasma_naranja.addImage("Fantasma_naranja",fantasma_naranjaImg)
fantasma_naranja.scale=0.02
fantasma_rojo= createSprite(310,204,15,15)
fantasma_rojo.shapeColor="red"
fantasma_rojo.addImage("Fantasma_Rojo",fantasma_RojoImg)
fantasma_rojo.scale=0.07
fantasma_azul = createSprite(335,204,15,15)
fantasma_azul.shapeColor="red"
fantasma_azul.addAnimation("fantasma_azul",fantasma_AzulImg)
fantasma_azul.scale=0.10
